// 일봉 스윙 — 대가 7모델 + 지표 (공용). 기획: docs/predict-daily-spec.md 3장.
// daily-swing-backtest.ts(채점)와 daily-swing-strategy.ts(운영 시뮬)가 함께 사용.
...
export function dmiAdx(bars: PredictDailyBar[], period = 14): Dmi {
  const n = bars.length;
...
// ATR14 (와일더 평활)
export function atr14(bars: PredictDailyBar[]): (number | null)[] {
  const n = bars.length;
...
export const MODELS: { id: string; label: string; run: (bars: PredictDailyBar[]) => Stance[] }[] = [

...
| US_PCE_20260930 | 9/30 08:30 ET → 9/30 21:30 | **10/1(목)** | 10/1·2·6·7·8 (**10/5 = 개천절 대체공휴일 휴장** — T5-1 XKRX 계산으로 정정) | 독립 (FOMC 창 9/17·18·21·22·23, 추석 9/24·25 휴장은 창 밖) |
| US_NFP_20261002 | 10/2 → 10/2 21:30 | **10/6(화)** (정정: 10/5 휴장) | 10/6·7·8·12·13 (10/9 한글날 휴장) | **비독립** — 10/6 ∈ PCE 창 |
| SEC_PRELIM_20261008(tentative) | 10/8 08:00 KST | 10/8 | 10/8·12·13·14·15 | **비독립** — 10/8 ∈ PCE 창(체인 상속 group=PCE)·NFP 창(비독립 이벤트의 창도 후속 이벤트를 오염시킴 — 규칙: "앞선 **어떤** 이벤트의 창 안이면 비독립"). EARNINGS_CLUSTER 아님(NFP는 매크로) |

...
export const SIGNAL_CONFIG = {
  ...
  moveAlert: {
    ...
    // 코스피200 선물 ±% — 첫 감지선 0.7 (±1은 간격이 크다는 사용자 피드백 2026-07-06.
    // ±0.5는 평온한 날에도 걸려 과다 — 0.7이 노이즈 경계). 이후 단계는 벌려 문자 총량 관리.
    futLevels: [0.7, 1.5, 2.5, 4],
    ...
    // 첫 반락 경고는 고점 대비 -1.0%p (1.5%p는 늦다는 사용자 피드백 — 고점 +1.5%면 +0.5%에서 1차 경고)
    futSwingLevels: [1, 2, 4],

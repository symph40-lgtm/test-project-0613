...
export const SIGNAL_CONFIG = {
  ...
  // C6 미 10년물 금리 절대 레벨 경계 (사용자 지정 2026-07-13: "4.57이면 중립이 아니라 중립에서
  // 위험으로 진행" — 전일 변화만이 아니라 레벨 구간을 함께 판정). %
  us10yWarn: 4.5,          // 경계 구간 시작 — 이 위에서 상승 중이면 하방
  us10yDanger: 4.8,        // 위험 구간 — 뚜렷한 완화(-0.03%p↓) 아니면 하방

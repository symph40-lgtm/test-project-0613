...
const PAUSE_ALLOW_KEYS = /^(trend_up|trend_down|vrebound_long|us_trend_up|us_trend_down)(_cancel)?$|^(us)?predict_(tr|rev9|chg|cp|recut|sell|prog5)|^uspredict_v2_(entry|rev|stop|conf|opp|ovn|bed)/;

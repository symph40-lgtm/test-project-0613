...
export const PREDICT_CONFIG = {
  ...
  // 스트림 반전봉 단축 (사용자 승인 2026-07-25): 본피셔 C반전 5→3봉 — 판정 스트림·전이 모니터·
  // 실시간 조회 전용 (확정 모델 스냅샷·채점·백테스트·삼전 트래킹은 원전 5봉 유지 — 강돌파와 동일 원칙).
  // 근거 (scripts/reversal-sweep.ts, 224일×하닉·삼전): 가짜 반전 증가 0 (하닉 10→10·삼전 4→4),
  // 전환 2.4~2.7분 조기화, 2레그 누적 하닉 +7.1→+11.7·삼전 +54.2→+56.5%p (4반쪽 3개선·1동률).
  // 2봉은 하닉 전반 악화로 기각. 반전일 표본 25일 — 라이브 반전 사례로 계속 감시.

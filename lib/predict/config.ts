...
export const PREDICT_CONFIG = {
  ...
  // 조기 구간 피셔 오프셋 인하 (사용자 승인 2026-07-20 밤, 10:30까지 확장 지시): 0.15 → 0.10.
  // 220일 실측: 09:30 컷 신호 75→91회·스탑 누적 +44.3→+67.7%p / 10:30 컷 77→100회·+5.6→+7.3%p
  // — "이른 시각은 낮은 문턱(기회), 늦은 시각은 높은 문턱(확인)". 11:00 이후·확정·모델 채점은 0.15.
  // 검증: 시각별 슬롯 채점이 라이브 누적 + 8/24 평가에서 재현 여부 재점검.
  earlyOffsetRatio: 0.1,
  earlyOffsetUntil: "10:30", // 이 체크포인트까지(포함) 0.10 적용

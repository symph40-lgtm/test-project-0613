...
export const PREDICT_CONFIG = {
  ...
  // 조기 구간(09:30~10:29) 피셔 오프셋 인하 (사용자 승인 2026-07-20 밤): 0.15 → 0.10.
  // 220일 실측: 09:30 컷 신호 75→91회·적중 동일(50%)·스탑 누적 +44.3→+67.7%p — "이른 시각은
  // 낮은 문턱(기회), 늦은 시각은 높은 문턱(확인)" 구조. 10:30 이후·확정·모델 채점은 0.15 유지.

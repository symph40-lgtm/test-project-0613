  ...
  return (
    <PageShell title="운영 설정 · 지시" badge="OPS" width="default">
      ...
      <a href="/fisher" className="mb-3 flex items-center justify-between rounded-[18px] border border-hairline bg-canvas p-5 hover:bg-pearl/40">
        <span>
          <span className="block text-[14px] font-semibold">피셔 판정 실시간 →</span>
          <span className="block text-[12px] text-ink-48">하닉 · 삼전 · SOXX 즉시 판정 + 문자 (별도 페이지)</span>
        </span>
      </a>
      <a href="/timeline" className="mb-4 flex items-center justify-between rounded-[18px] border border-hairline bg-canvas p-5 hover:bg-pearl/40">
        <span>
          <span className="block text-[14px] font-semibold">판정 타임라인 →</span>
          <span className="block text-[12px] text-ink-48">프리장~애프터장 전체 판정 문자를 발송 순서대로</span>
        </span>
      </a>

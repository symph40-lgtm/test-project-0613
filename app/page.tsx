...
const menuGroups = [
  ...
  },
  {
    title: "시장 · 알림 · 분석",
    items: [
      // MT 별도 메뉴 (발주자 지시 2026-08-18 §1): 일봉 갭예측 위 — 3종목 톤 줄·60일 추이·부품 계급표. 1단계 표시 전용
      { name: "MT 시장 톤 (1단계 표시 · 검증 미달 꼬리표)", href: "/mt" },
      // 최상단 (사용자 지시 2026-08-11): 일봉 갭 예측 — 신모델 현황 윗줄 배치. 60일 log-only 검증 중
      { name: "일봉 갭 예측 (G1A·G1B — 60일 검증중)", href: "/g1" },
      // (사용자 지시 2026-08-05 밤): 실전 매매 기준 = 신모델 3종 현황 — ① 판정보다 위에 배치
      { name: "★ 신모델 현황 (하이닉스·삼성전자·SOXX)", href: "/newmodel" },
      ...
      // 피셔 실시간 문의 (사용자 지시 2026-07-28: ①번 밑단에 배치) — 버튼 1회 = 즉시 판정+문자
      { name: "피셔 판정 실시간 (하닉·삼전·SOXX)", href: "/fisher" },
